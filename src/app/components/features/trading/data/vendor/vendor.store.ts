  ...
  withMethods(
    (
      ...
      const catalogCache = createCachedCrudLoader<Vendor>({
        ...
        loadCatalog: () => catalogCacheStore.loadCatalog<Vendor>(CACHE_NAME),
      ...
      const cacheCatalogEntry = (vendor: Vendor): void => {
        ...
        void catalogCacheStore.persistCatalog(CACHE_NAME, store.vendor().catalog);
      };
